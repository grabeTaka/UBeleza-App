...
class EstablishmentsList extends StatefulWidget {
  ...
  @override
  _EstablishmentsListState createState() => _EstablishmentsListState();
}

class _EstablishmentsListState extends State<EstablishmentsList> with TickerProviderStateMixin {
  AnimationController animationController;
  Future<List<Establishment>> establishmentsListData = Establishment.getAllList();
