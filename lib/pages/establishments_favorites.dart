...
class EstablishmentsFavorites extends StatefulWidget {
  const EstablishmentsFavorites({Key key, this.animationController}) : super(key: key);

  final AnimationController animationController;
  @override
  _EstablishmentsFavoritesState createState() => _EstablishmentsFavoritesState();
}

class _EstablishmentsFavoritesState extends State<EstablishmentsFavorites> with TickerProviderStateMixin {
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        type: 'Establishment',
        titleTxt: 'Estabelecimentos Favoritos',
        subTxt: 'Todos',
