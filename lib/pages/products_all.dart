import 'package:Ubeleza/components/products_list.dart';
...
class ProductsAll extends StatefulWidget {
  const ProductsAll({Key key, this.animationController}) : super(key: key);
...
class _ProductsAll extends State<ProductsAll> with TickerProviderStateMixin {
