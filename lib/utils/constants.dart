...
class _Config {
  ...
  static Map<String, dynamic> debugConstants = {
    SERVER_ONE: "http://192.168.0.151:3000",
    SERVER_TWO: "http://192.168.0.151:3000",
    WHERE_AM_I: "local",
  };

  static Map<String, dynamic> qaConstants = {
    SERVER_ONE: "https://ubeleza-api.herokuapp.com",
    SERVER_TWO: "https://ubeleza-api.herokuapp.com",
    WHERE_AM_I: "staging",
  };
